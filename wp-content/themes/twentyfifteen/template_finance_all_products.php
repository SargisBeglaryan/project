			  ...
			  <div class="tab-content">
			    <div role="tabpanel" class="tab-pane active" id="roleSaleContent">
					...
					<tbody>
						...
						<td><?php echo $roll['cost_price'];?></td>
						<td contenteditable='true' class="sale_product_selling_price"><?php echo $roll['selling_price'];?></td>
						<td><?php echo $roll['earnings'];?></td>
						<td contenteditable='true' class="sale_product_debt"><?php echo $roll['debt'];?></td>
						</tr>
						<?php
						}
						?>
			    ...
			    <div role="tabpanel" class="tab-pane" id="paperSaleContent">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $paper['cost_price'];?></td>
							<td contenteditable='true' class="sale_product_selling_price"><?php echo $paper['selling_price'];?></td>
							<td><?php echo $paper['earnings'];?></td>
							<td contenteditable='true' class="sale_product_debt"><?php echo $paper['debt'];?></td>
						</tr>
						<?php
						}
						?>
