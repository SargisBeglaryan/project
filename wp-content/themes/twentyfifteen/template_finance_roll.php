...
<?php get_header(); ?>
			...
			<table cellspacing="0" cellpadding="0" border="0" class="financeRoll">
				...
				<tbody>
					...
					<tr>
						...
						<td onclick="window.document.location='customer-orders/?type=roll&customer=<?php echo $print['customer'];?>';"  class="customerName allCustomersList"><?php echo $print['customer'];?></td>
	...
	<div class="modal fade" tableName="financeRoll" id="customerModal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
